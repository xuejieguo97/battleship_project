document.addEventListener('DOMContentLoaded',() => {
    ...
    function rotate(){
        if(isHorizontal){
            destoryer.classList.toggle('destroyer-container-verticle')
    ...
    function dragDrop(){
        ...
        const notAllowedVerticle = [99, 98, 97, 96, 95, 94, 93, 92, 91, 90,
                                    89, 88, 87, 86, 85, 84, 83, 82, 81, 80,
                                    79, 78, 77, 76, 75, 74, 73, 72, 71, 70,
                                    69, 68, 67, 66, 64, 64, 63, 62, 61, 60,]
        let newNotAllowedVerticle = notAllowedVerticle.splice(0, 10 * lastShipIndex)
    ...
    function checkForWins(){
        ...
        if(submarineCount === 3){
            submarineCount = 10
            infoDisplay.innerHTML = `You sunk the ${enemy}'s submarines`
        }
        if(cruiserCount === 3){
            cruiserCount = 10
...
`      }
        ...
        if(cpuDestroyerCount + cpuSubmarineCount + cpuDestroyerCount + cpuBattleshipCount+ cpuCarrierCount === 50 ){
